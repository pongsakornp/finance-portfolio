...
describe("monthlyBreakdown", () => {
  it("aggregates by month and sorts newest first", () => {
    const rows = monthlyBreakdown([
      { type: "buy", quantity: 2, price: 50, fee: 1, occurredAt: new Date("2026-01-15") }, // invested 101
      { type: "dividend", quantity: 7, price: 0, fee: 0, occurredAt: new Date("2026-01-20") },
      { type: "sell", quantity: 1, price: 60, fee: 1, occurredAt: new Date("2026-02-01") }, // proceeds 59
    ]);
